...
public class FragmentAccompanimentMenuBindingImpl extends FragmentAccompanimentMenuBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        boolean viewModelEntreeNameEqualsViewModelMenuItemsPicklesName = false;
        ...
        boolean viewModelEntreeNameEqualsViewModelMenuItemsBerriesName = false;
        ...
        if ((dirtyFlags & 0x1bL) != 0) {
            ...
            if ((dirtyFlags & 0x1aL) != 0) {
                    ...
                    if (viewModelEntreeName != null) {
                        // read viewModel.entree.getValue().name.equals(viewModel.menuItems["bread"].name)
                        viewModelEntreeNameEqualsViewModelMenuItemsBreadName = viewModelEntreeName.equals(viewModelMenuItemsBreadName);
                        // read viewModel.entree.getValue().name.equals(viewModel.menuItems["pickles"].name)
                        viewModelEntreeNameEqualsViewModelMenuItemsPicklesName = viewModelEntreeName.equals(viewModelMenuItemsPicklesName);
                        // read viewModel.entree.getValue().name.equals(viewModel.menuItems["berries"].name)
                        viewModelEntreeNameEqualsViewModelMenuItemsBerriesName = viewModelEntreeName.equals(viewModelMenuItemsBerriesName);
                    }
        ...
        if ((dirtyFlags & 0x1aL) != 0) {
            ...
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.berries, viewModelEntreeNameEqualsViewModelMenuItemsBerriesName);
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.bread, viewModelEntreeNameEqualsViewModelMenuItemsBreadName);
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.pickles, viewModelEntreeNameEqualsViewModelMenuItemsPicklesName);
        }
