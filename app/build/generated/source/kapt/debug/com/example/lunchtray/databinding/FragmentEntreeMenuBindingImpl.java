...
public class FragmentEntreeMenuBindingImpl extends FragmentEntreeMenuBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        boolean viewModelEntreeNameEqualsViewModelMenuItemsPastaName = false;
        ...
        boolean viewModelEntreeNameEqualsViewModelMenuItemsCauliflowerName = false;
        java.lang.String viewModelMenuItemsPastaGetFormattedPrice = null;
        boolean viewModelEntreeNameEqualsViewModelMenuItemsChiliName = false;
        ...
        boolean viewModelEntreeNameEqualsViewModelMenuItemsSkilletName = false;
        ...
        if ((dirtyFlags & 0x1bL) != 0) {
            ...
            if ((dirtyFlags & 0x1aL) != 0) {
                    ...
                    if (viewModelEntreeName != null) {
                        // read viewModel.entree.getValue().name.equals(viewModel.menuItems["pasta"].name)
                        viewModelEntreeNameEqualsViewModelMenuItemsPastaName = viewModelEntreeName.equals(viewModelMenuItemsPastaName);
                        // read viewModel.entree.getValue().name.equals(viewModel.menuItems["cauliflower"].name)
                        viewModelEntreeNameEqualsViewModelMenuItemsCauliflowerName = viewModelEntreeName.equals(viewModelMenuItemsCauliflowerName);
                        // read viewModel.entree.getValue().name.equals(viewModel.menuItems["chili"].name)
                        viewModelEntreeNameEqualsViewModelMenuItemsChiliName = viewModelEntreeName.equals(viewModelMenuItemsChiliName);
                        // read viewModel.entree.getValue().name.equals(viewModel.menuItems["skillet"].name)
                        viewModelEntreeNameEqualsViewModelMenuItemsSkilletName = viewModelEntreeName.equals(viewModelMenuItemsSkilletName);
                    }
        ...
        if ((dirtyFlags & 0x1aL) != 0) {
            ...
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.cauliflower, viewModelEntreeNameEqualsViewModelMenuItemsCauliflowerName);
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.chili, viewModelEntreeNameEqualsViewModelMenuItemsChiliName);
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.pasta, viewModelEntreeNameEqualsViewModelMenuItemsPastaName);
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.skillet, viewModelEntreeNameEqualsViewModelMenuItemsSkilletName);
        }
        if ((dirtyFlags & 0x19L) != 0) {
            // api target 1
