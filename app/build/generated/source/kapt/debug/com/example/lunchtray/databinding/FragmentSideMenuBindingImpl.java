...
public class FragmentSideMenuBindingImpl extends FragmentSideMenuBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        boolean viewModelEntreeNameEqualsViewModelMenuItemsSoupName = false;
        ...
        boolean viewModelEntreeNameEqualsViewModelMenuItemsRiceName = false;
        ...
        boolean viewModelEntreeNameEqualsViewModelMenuItemsSaladName = false;
        java.lang.String viewModelMenuItemsPotatoesGetFormattedPrice = null;
        boolean viewModelEntreeNameEqualsViewModelMenuItemsPotatoesName = false;
        ...
        if ((dirtyFlags & 0x1bL) != 0) {
            ...
            if ((dirtyFlags & 0x1aL) != 0) {
                    ...
                    if (viewModelEntreeName != null) {
                        // read viewModel.entree.getValue().name.equals(viewModel.menuItems["soup"].name)
                        viewModelEntreeNameEqualsViewModelMenuItemsSoupName = viewModelEntreeName.equals(viewModelMenuItemsSoupName);
                        // read viewModel.entree.getValue().name.equals(viewModel.menuItems["rice"].name)
                        viewModelEntreeNameEqualsViewModelMenuItemsRiceName = viewModelEntreeName.equals(viewModelMenuItemsRiceName);
                        // read viewModel.entree.getValue().name.equals(viewModel.menuItems["salad"].name)
                        viewModelEntreeNameEqualsViewModelMenuItemsSaladName = viewModelEntreeName.equals(viewModelMenuItemsSaladName);
                        // read viewModel.entree.getValue().name.equals(viewModel.menuItems["potatoes"].name)
                        viewModelEntreeNameEqualsViewModelMenuItemsPotatoesName = viewModelEntreeName.equals(viewModelMenuItemsPotatoesName);
                    }
        ...
        if ((dirtyFlags & 0x1aL) != 0) {
            ...
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.potatoes, viewModelEntreeNameEqualsViewModelMenuItemsPotatoesName);
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.rice, viewModelEntreeNameEqualsViewModelMenuItemsRiceName);
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.salad, viewModelEntreeNameEqualsViewModelMenuItemsSaladName);
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.soup, viewModelEntreeNameEqualsViewModelMenuItemsSoupName);
        }
        if ((dirtyFlags & 0x19L) != 0) {
            // api target 1
